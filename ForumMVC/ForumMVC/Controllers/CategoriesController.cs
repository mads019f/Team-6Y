...
namespace ForumMVC.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(Services service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Description,CreatedWhen")] Category category)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var category = _service.GetCategoryFromIdAsync(id);
            if (category == null)
            {
                return NotFound();
            }
